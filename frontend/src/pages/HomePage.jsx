...
import purse from "../organic/organic/Sports/purse.jpg";
import img1 from "../organic/organic/cloth/WhatsApp Image 2026-07-01 at 2.08.01 PM.jpeg";
import Bamboo_Electric_Toothbrush from "../organic/organic/Electronics/Eco friendly Bamboo Electric Toothbrush.jpg";
import book1 from "../organic/organic/Books/Book1.jpeg";
import {
  ArrowRight,
  Zap,
  Shirt,
...
const HomePage = () => {
  ...
  const HERO_IMAGES = [
    ...
    {
      src: Bamboo_Electric_Toothbrush,
      label: "Electronics",
    },
    {
      src: book1,
  ...
  const WHY_US = [
    {
      icon: Award,
      title: "Top Brands",
      desc: "Authentic products from 500+ verified brands.",
      color: "#feca57",
    },
    {
      icon: Truck,
      title: "Express Delivery",
      desc: "Same-day & next-day delivery across the city.",
      color: "#e94560",
    },
    {
      icon: ShieldCheck,
      title: "100% Authentic",
      desc: "Every product verified before dispatch.",
      color: "#48dbfb",
    },
    {
      icon: RefreshCw,
      title: "Easy Returns",
      desc: "14-day hassle-free returns on all orders.",
      color: "#ff9f43",
    },
  ];
    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative flex items-center overflow-hidden hero-section">
        ...
        {[...Array(4)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              height: `${180 + i * 80}px`,
              background:
                i % 2 === 0 ? "rgba(233,69,96,0.12)" : "rgba(162,155,254,0.08)",
              top: `${10 + i * 20}%`,
              left: `${-5 + i * 22}%`,
            }}
        ...
        <div className="container">
          <div
            className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center py-16 lg:py-0"
          ...
          >
            ...
            <motion.div {...fadeUp(0)} className="flex flex-col">
              ...
              <motion.div
                {...fadeUp(0.15)}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs sm:text-sm font-semibold mb-7 self-start"
                style={{
              ...
              >
                <Zap size={13} />
                India'sFastest Growing Online Store
              </motion.div>

              <motion.h1
                {...fadeUp(0.2)}
                className="text-4xl sm:text-5xl md:text-6xl xl:text-[4.5rem] font-black leading-[1.05] mb-6"
                style={{
              ...
              <motion.p
                {...fadeUp(0.3)}
                className="text-base sm:text-lg text-white/55 mb-10 max-w-[480px] leading-relaxed"
              >
                Discover thousands of products across Clothing, Electronics,
                Sports, Beauty, Home &amp; Kitchen, and Books — all in one
                place.
              </motion.p>
              ...
              >
                <Link
                  to="/shop"
                  className="btn-gold text-sm sm:text-base px-6 sm:px-8 py-3 font-bold"
                >
              ...
              >
                {STATS.map(({ icon: Icon, value, label }) => (
                  <div key={label} className="text-center sm:text-left">
                    <p
                      className="text-xl sm:text-2xl lg:text-3xl font-black gradient-text mb-1"
              ...
              {HERO_IMAGES.map((item, i) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, rgba(8,7,20,0.75) 0%, rgba(8,7,20,0.1) 50%, transparent 100%)",
                    }}
                  />
      ...
      <section className="section-gap">
        <div className="container">
          <motion.div {...inView()} className="text-center section-header">
              ...
              return (
                <motion.div key={cat.name} variants={stagger.item}>
                  <Link
                    ...
                    className="flex flex-col items-center gap-4 glass rounded-2xl p-5 sm:p-7 text-center card-hover group"
        ...
        <div className="container relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-14 gap-4">
            ...
            <motion.div {...inView(0.1)}>
              <Link
                to="/shop"
                className="btn-outline text-sm py-2 px-5 self-start sm:self-auto"
              >
      ...
      <section className="section-gap">
        <div className="container">
          <motion.div {...inView()} className="text-center section-header">
            <span className="section-label">
              <Star size={13} /> Our Promise
            </span>
            <h2 className="section-title">
              Why <span className="gradient-text">Green tigers?</span>
            </h2>
          </motion.div>
          ...
          <div className="info-grid">
            {WHY_US.map((f, i) => (
              <motion.div
                key={f.title}
                {...inView(i * 0.1)}
                className="glass-card p-7 sm:p-9 flex flex-col items-center text-center card-hover group"
              >
                <motion.div
      ...
      {/* ════════════════════════════════════════════
          CTA BANNER
      ════════════════════════════════════════════ */}
      <section className="py-20 lg:py-28 flex flex-col items-center text-center">
        <motion.div
          {...inView()}
          className="w-full mx-auto rounded-3xl relative overflow-hidden"
          style={{
            background:
              "linear-gradient(135deg, #e94560 0%, #7c3aed 50%, #feca57 100%)",
        ...
        >
          ...
          <div className="relative z-10 text-center px-8 py-16 sm:py-20 sm:px-14">
            <motion.h2
              {...inView(0.1)}
            ...
            <motion.p
              {...inView(0.2)}
              className="text-white/80 mb-10 max-w-lg mx-auto text-sm sm:text-base leading-relaxed"
            >
              Join 50,000+ happy customers. Register now and get access to
              exclusive deals.
            </motion.p>
            <motion.div
              {...inView(0.3)}
