...
const Footer = () => (
  <footer className="mt-24 relative overflow-hidden" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
    {/* Ambient background */}
    <div
      className="absolute inset-0 pointer-events-none"
      style={{
        background: 'radial-gradient(ellipse 80% 60% at 50% 100%, rgba(233,69,96,0.07) 0%, transparent 70%), rgba(0,0,0,0.45)',
      }}
    />
    ...
    <div className="relative z-10 container py-16 lg:py-20">
      <div className="footer-grid">
        ...
        <div>
          <Link to="/" className="inline-flex items-center gap-2.5 mb-5 group">
            ...
            <div>
              <p className="font-black text-lg gradient-text leading-tight" style={{ fontFamily: 'Poppins, sans-serif' }}>
                Green Tiger
              </p>
              <p className="text-xs text-white/30 tracking-widest uppercase">Shop Smart</p>
            </div>
          </Link>

          <p className="text-sm text-white/45 leading-relaxed mb-6 max-w-xs">
            Your one-stop online store for Clothing, Sports, Home &amp; Kitchen, Beauty, Electronics &amp; Books.
            Quality products, express delivery.
          </p>
        ...
        {/* ── Categories ──────────────── */}
        <div>
          <h4 className="font-bold text-sm text-white mb-5 uppercase tracking-widest" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Categories
          </h4>
        ...
        <div>
          ...
          <ul className="space-y-3.5">
            {[
              ...
              { Icon: Mail,   text: 'hello@greentiger.pk' },
            ].map(({ Icon, text }) => (
              <li key={text} className="flex items-start gap-3 text-sm text-white/45">
          ...
          {/* Newsletter mini */}
          <div className="mt-6">
            <p className="text-xs text-white/35 mb-2 font-medium uppercase tracking-widest">Newsletter</p>
      ...
      <div className="mt-14 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3"
        ...
        <p className="text-xs text-white/25 text-center sm:text-left">
          © {new Date().getFullYear()} Green Tiger. All rights reserved.
        </p>
        ...
        <p className="text-xs text-white/25">🛍️ Shop smart, shop Green Tiger.</p>
      </div>
    </div>
  </footer>
);
